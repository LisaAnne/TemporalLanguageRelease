...
python utils/fusion.py --rgb_tag $dataset/emnlp2018_rgb_mcn-tall-loss_$dataset \
                       --flow_tag $dataset/emnlp2018_flow_mcn-tall-loss_$dataset \
                       --iter 45000 \
                       --dataset $dataset \
                       --tall \
                       --set val \
...
python utils/fusion.py --rgb_tag $dataset/emnlp2018_rgb_tall-noTEF_$dataset \
                       --flow_tag $dataset/emnlp2018_flow_tall-noTEF_$dataset \
                       --iter 45000 \
                       --dataset $dataset \
                       --tall \
                       --set val \
...
python utils/fusion.py --rgb_tag $dataset/emnlp2018_rgb_mcn-tall-sim_$dataset \
                       --flow_tag $dataset/emnlp2018_flow_mcn-tall-sim_$dataset \
                       --iter 45000 \
                       --dataset $dataset \
                       --set val \
                       --quiet 
